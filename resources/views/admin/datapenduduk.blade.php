...
<html lang="id">
	<head>
		...
		<style>
			...
			/* TABEL DENGAN TEXT WRAPPING YANG BENAR */
			.custom-table {
				width: 100%;
				border-collapse: separate;
				border-spacing: 0;
				table-layout: fixed; /* Penting untuk konsistensi width */
			}
			...
			/* KHUSUS untuk kolom pertama (Identitas) - TEXT WRAPPING */
			.custom-table td:first-child {
				...
				hyphens: auto;
				max-width: 250px; /* Batas maksimal lebar untuk wrapping */
			}

			/* Nama penduduk yang panjang - AKAN WRAP KE BAWAH */
			.penduduk-info .fw-bold {
				word-wrap: break-word;
				word-break: break-word;
				white-space: normal;
				overflow-wrap: break-word;
			...
			/* Alamat info juga perlu wrapping */
			.alamat-info {
				word-wrap: break-word;
				word-break: break-word;
				white-space: normal;
				overflow-wrap: break-word;
				line-height: 1.4;
				max-width: 200px; /* Batas untuk kolom alamat */
			}

			/* Small text dalam penduduk info */
			.penduduk-info small {
				display: block;
				word-break: break-word;
				white-space: normal;
			...
			/* Container untuk mencegah horizontal scroll */
			.table-container {
				overflow-x: auto;
				width: 100%;
			}

			/* Width kolom yang tetap */
			.custom-table th:nth-child(1), .custom-table td:nth-child(1) { width: 25%; } /* Identitas */
			.custom-table th:nth-child(2), .custom-table td:nth-child(2) { width: 12%; } /* Gender */
			.custom-table th:nth-child(3), .custom-table td:nth-child(3) { width: 20%; } /* Alamat */
			.custom-table th:nth-child(4), .custom-table td:nth-child(4) { width: 8%; }  /* RT/RW */
			.custom-table th:nth-child(5), .custom-table td:nth-child(5) { width: 15%; } /* TTL */
			.custom-table th:nth-child(6), .custom-table td:nth-child(6) { width: 8%; }  /* Status */
			.custom-table th:nth-child(7), .custom-table td:nth-child(7) { width: 12%; } /* Aksi */
			...
			.action-buttons {
				display: flex;
				gap: 0.5rem;
				white-space: nowrap; /* Buttons tetap dalam satu baris */
			}
			...
			<div class="page-main-wrapper flex-1 p-4 lg:p-8 transition-all duration-300" id="pageMainContent">
				...
				<div class="page-content">
					...
					<div class="content-card penduduk-fade-in" style="animation-delay: 0.2s;">
						...
						<!-- Table Section - FIXED TEXT WRAPPING -->
								...
								<tbody>
									@forelse($dataPenduduk ?? [] as $index => $item)
										...
										<tr class="penduduk-fade-in" style="animation-delay: {{ 0.3 + ($index * 0.1) }}s;">
											...
											<td>
												<!-- ALAMAT AKAN WRAP JIKA PANJANG -->
												<div class="alamat-info">{{ $item->alamat ?? 'Alamat tidak tersedia' }}</div>
												@if($item->telepon)
								...
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control" id="nik" name="nik" required maxlength="16" placeholder="Masukkan NIK 16 digit" value="{{ old('nik') }}">
										</div>
										<div class="col-md-6 mb-3">
											<label for="no_kk" class="form-label">No. KK</label>
											<input type="text" class="form-control" id="no_kk" name="no_kk" maxlength="16" placeholder="Masukkan No. KK" value="{{ old('no_kk') }}">
										</div>
									</div>
									<div class="mb-3">
										<label for="nama" class="form-label">Nama Lengkap <span class="text-danger">*</span></label>
										<input type="text" class="form-control" id="nama" name="nama" required placeholder="Masukkan nama lengkap" value="{{ old('nama') }}">
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control" id="pekerjaan" name="pekerjaan" placeholder="Masukkan pekerjaan" value="{{ old('pekerjaan') }}">
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6 mb-3">
											...
											<input type="text" class="form-control" id="telepon" name="telepon" placeholder="Nomor telepon" value="{{ old('telepon') }}">
										</div>
										<div class="col-md-6 mb-3">
...
</html><label for="rt" class="form-label">RT</label>
											<input type="text" class="form-control" id="rt" name="rt" maxlength="3" placeholder="001" value="{{ old('rt') }}">
										</div>
										<div class="col-md-3 mb-3">
											<label for="rw" class="form-label">RW</label>
											<input type="text" class="form-control" id="rw" name="rw" maxlength="3" placeholder="001" value="{{ old('rw') }}">
										</div>
										<div class="col-md-3 mb-3">