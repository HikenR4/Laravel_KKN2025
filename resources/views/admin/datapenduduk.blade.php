    ...
    <head>
        ...
        <style>
            ...
            .custom-table {
                ...
                border-spacing: 0;
                table-layout: fixed !important; /* Penting untuk konsistensi width */
            }
            ...
            .custom-table th:nth-child(1), .custom-table td:nth-child(1) { width: 20%; } /* Identitas */
            .custom-table th:nth-child(2), .custom-table td:nth-child(2) { width: 15%; } /* Gender */
